...
class Address {//class
    ...
    public function __construct(string $street, string $number, string $complement, string $district, string $postalCode, string $city, string $state, string $country){//__construct
    ...
    public function getDOMElement($node = "address"):DOMElement{//getDOMElement

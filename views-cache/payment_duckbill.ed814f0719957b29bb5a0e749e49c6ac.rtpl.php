            ...
            <form action="/payment_duckbill/credit" class="needs-validation" method="POST" name="checkout" id="form-credit">
              ...
              <div class="row">
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control" id="cc-expiration" value="<?php echo htmlspecialchars( $order["mouthCard"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="" name="expirames"  required>
                  <div class="invalid-feedback">
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control" id="cc-expiration" value="<?php echo htmlspecialchars( $order["yearCard"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="" name="expiraano"  required>
                  <div class="invalid-feedback">
                    Expiration date required
                  </div>
                </div>
